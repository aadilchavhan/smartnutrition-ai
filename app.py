...
# Custom modules (Make sure these files exist in your folder)
import bim_calculator
import mealplanner
import home
import calorie_calculator
...
with col2:
    # Ensure assets/logo.jpg exists, otherwise this will show a broken image
    try:
        st.image("assets/logo.jpg", width=200)
    except:
        st.warning("Logo not found. Check assets folder.")
